...
<html>
  ...
  <link href="https://fonts.googleapis.com/css?family=Lobster" rel="stylesheet">
    <title>Avanger: Koniec gry</title>
  <style>
  .a{
	  font-size: 42px;
...
<div class="container">
 ...
 <div class="col-md-5">
<img class="img-responsive" src = "av1.jpg" alt = "avengers" >
</div>
<div class="col-md-7">
<div class="a"><p>Avengers: Koniec gry</p></div>
<br><br>
<div class="b"><p>Akcja / Fantasy </p></div>
<div class="c"><p>Czas trwania: 182 min. Od lat: 13 Produkcja: USA [2019]<br> Premiera: 25.04.2019 (Polska)</p></div>
<br><hr><br>
<div class="b"><p>Opis filmu:</p></div>
<div class="c"><p>Po wymazaniu połowy życia we Wszechświecie przez Thanosa, Avengersi starają się zrobić wszystko co konieczne, aby pokonać szalonego tytana.</p></div>
<br><hr><br>
</div>
<div class="col-md-2">
<a class="btn btn-primary btn-lg" href="https://www.youtube.com/watch?v=TcMBFSGVi1c">Zwiastun</a>
</div>
<div class="col-md-3 z">

<form action="kupno_biletu.php" method="get">
<input type="hidden" id="idfilmu" name="idfilmu" value="Avenger: koniec gry">
